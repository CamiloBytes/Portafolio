# 📌 Lista de Tareas - Mi Portafolio Personal

## 1. Preparación del proyecto
- [X] Crear proyecto con **Vite + React + TypeScript**
- [X] Instalar dependencias principales (react-router-dom, tailwindcss, framer-motion)
- [X] Configurar estructura de carpetas (`components/`, `pages/`, `assets/`, `styles/`)
...
## 7. Futuras mejoras
- [ ] Blog personal con artículos o reflexiones
- [ ] Dashboard sencillo para agregar proyectos desde un JSON/API
- [ ] Integrar analíticas (ejemplo: Google Analytics)
